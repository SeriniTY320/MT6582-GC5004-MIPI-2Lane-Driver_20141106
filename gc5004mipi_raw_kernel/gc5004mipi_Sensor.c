...
static void GC5004MIPI_Init_Settings(void)
{
	...
	GC5004MIPI_write_cmos_sensor(0x22, 0xb2); // 82 20140722
	...
	//////////////////////   GAIN   /////////////////////
	/////////////////////////////////////////////////////
	GC5004MIPI_write_cmos_sensor(0xb0, 0x70);// 50 20140722
	GC5004MIPI_write_cmos_sensor(0xb1, 0x01);
	...
	GC5004MIPI_write_cmos_sensor(0x15, 0x10); //0x12 20140722
	...
	GC5004MIPI_write_cmos_sensor(0x10, 0x91); // 0x93  20140722
	GC5004MIPI_write_cmos_sensor(0xfe, 0x00);
...
static void GC5004MIPIPreviewSettings(void)
{
	...
	GC5004MIPI_write_cmos_sensor(0x4f, 0x06); 
